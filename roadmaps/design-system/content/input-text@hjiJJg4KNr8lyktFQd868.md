...
A entrada de texto permite que os usuários insiram e editem texto.

- **Estado Desabilitado:** Impede interações de entrada e remove seu valor da submissão do formulário.
- **Placeholder:** Quando não há valor inserido, mostre um placeholder com um exemplo potencial de valor. Não use placeholders como rótulos para os campos de entrada.
...
- **Autocompletar:** Quando aplicável, adicionar suporte para o atributo HTML autocomplete permitirá que os usuários insiram facilmente diferentes tipos de dados.
